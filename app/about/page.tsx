...
const timelineEvents = [
  {
    year: '2025',
    events: [
      { text: 'Kantar BrandZ 1st in Automobile Category 3 Consecutive Years', img: '/assets/about/slider-img-2.jpg' },
      { text: 'Chery Group enters Fortune Global 500, Ranking No. 233', img: '/assets/about/slider-img.jpg' },
    ],
  },
  {
    year: '2024',
  ...
  { year: '2021', events: [{ text: 'Chery 2.0T GDI engine wins title of "China Heart of 2021"', img: '/assets/about/2021_01.jpg' }] },
  { year: '2020', events: [
  ...
  { year: '2017', events: [{ text: 'Chery design wins international award in Tokyo', img: '/assets/about/2017.jpg' }] },
  { year: '2015', events: [
  ...
  { year: '2014', events: [{ text: 'Chery factory inaugurated in Jacareí, São Paulo, Brazil', img: '/assets/about/2014.jpg' }] },
  { year: '2007', events: [{ text: '1,000,000th Chery car rolls off the production line', img: '/assets/about/2007_01.jpg' }] },
  { year: '2001', events: [{ text: 'First batch of 10 Chery cars exported through Tianjin Port', img: '/assets/about/2001.jpg' }] },
  { year: '1997', events: [{ text: 'Chery Automobile Company established in March 1997', img: '/assets/about/1997.jpg' }] },
]
...
export default function AboutPage() {
  ...
  const handleYearChange = (year: string) => { setActiveYear(year); setActiveEvent(0) }
  ...
  return (
    <div className="bg-white">
      ...
      {/* ABOUT CHERY — full-width banner image with text below */}
        ...
        <div className="max-w-[1360px] mx-auto">
          <div className="grid md:grid-cols-2 gap-10 items-start mb-10">
            <div>
              ...
              <div className="space-y-4 text-gray-600 font-light leading-relaxed text-[15px]">
            ...
            <div className="flex flex-col gap-4 md:pt-16">
              <div className="bg-[#111] text-white rounded-2xl p-8 flex items-center gap-6">
                <div>
                  <p className="text-5xl font-light">22</p>
                  <p className="text-xs tracking-widest text-gray-400 uppercase mt-1">Consecutive Years #1</p>
                  <p className="text-sm text-gray-300 font-light mt-2">China&apos;s No.1 Passenger Vehicle Exporter</p>
                </div>
              </div>
              <div className="bg-[#F7F7F7] rounded-2xl p-8 flex items-center gap-6">
                <div>
                  <p className="text-5xl font-light text-gray-900">No. 233</p>
                  <p className="text-xs tracking-widest text-gray-400 uppercase mt-1">Fortune Global 500</p>
                  <p className="text-sm text-gray-600 font-light mt-2">Climbed 152 places — 2025</p>
                </div>
              </div>
            </div>
          </div>
          {/* Full-width banner image */}
          <div className="rounded-2xl overflow-hidden w-full" style={{ height: 320 }}>
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              src="/assets/about/slider-img-2.jpg"
              alt="Chery — Kantar BrandZ 1st in Automobile Category"
          ...
          <div className="grid md:grid-cols-2 gap-10 items-start">
            ...
            <div className="order-2 md:order-1 flex flex-col gap-4">
              <div className="rounded-2xl overflow-hidden" style={{ height: 360 }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/assets/about/aboutmaenew.jpg"
                  alt="MAE-Chery Distribution Agreement Signing"
                  className="w-full h-full object-cover"
                  style={{ objectPosition: 'center top' }}
                />
              </div>
              {/* Fortune 500 banner as a card below */}
              <div className="rounded-2xl overflow-hidden" style={{ height: 160 }}>
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src="/assets/about/slider-img.jpg"
                  alt="Chery Fortune Global 500"
                  className="w-full h-full object-cover"
            ...
            <div className="order-1 md:order-2 md:pt-4">
              ...
              <div className="mt-8 bg-white rounded-2xl p-6 flex items-center gap-4 border border-gray-200">
                <p className="text-4xl font-light text-gray-900">60+</p>
                <div>
                  <p className="text-xs tracking-widest text-gray-400 uppercase font-semibold">Years of Excellence</p>
                  <p className="text-sm text-gray-600 font-light mt-1">Master Group of Industries, Pakistan</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-[1360px] mx-auto grid md:grid-cols-2 gap-8">
          <div className="bg-[#111] text-white rounded-2xl p-10 md:p-14 flex flex-col justify-between min-h-[280px]">
            <div className="w-12 h-12 rounded-full border border-white/20 flex items-center justify-center mb-8">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 8v4l3 3"/></svg>
            </div>
            <div>
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-10 md:p-14 flex flex-col justify-between min-h-[280px]">
            <div className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center mb-8">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
            </div>
            <div>
        ...
        <div className="max-w-[1360px] mx-auto">
          ...
          <div className="flex gap-0 overflow-x-auto pb-2 mb-10 border-b border-white/10 scrollbar-none">
            {timelineEvents.map(e => (
              <button key={e.year} onClick={() => handleYearChange(e.year)}
          ...
          {/* Full-width image, then events grid below */}
          <div className="flex flex-col gap-6">
            <div className="relative rounded-2xl overflow-hidden bg-gray-800 w-full" style={{aspectRatio:'16/7'}}>
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img key={`${activeYear}-${activeEvent}`}
              ...
              <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent p-6 md:p-8">
                <p className="text-5xl font-light text-white/20 mb-1">{activeYear}</p>
                <p className="text-white text-sm md:text-base font-light leading-snug max-w-2xl">{activeTimeline.events[activeEvent]?.text}</p>
              </div>
            </div>
            <div className="grid md:grid-cols-2 gap-3 max-h-[340px] overflow-y-auto pr-1 scrollbar-none">
              {activeTimeline.events.map((ev, i) => (
                <button key={`${activeYear}-event-${i}`} onClick={() => setActiveEvent(i)}
                  className={`flex gap-4 items-start text-left px-4 py-3 rounded-xl border transition-all duration-200 ${
                    activeEvent === i ? 'bg-white/10 border-white/20 text-white' : 'border-white/5 text-gray-400 hover:text-gray-200 hover:bg-white/5'
                  }`}>
                  <span className="text-lg font-light text-gray-600 flex-shrink-0 mt-0.5">{String(i + 1).padStart(2, '0')}</span>
      ...
      <section className="py-20 px-5 md:px-10 text-center">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <Link href="/test-drive">
            <button className="h-12 px-8 bg-black text-white rounded-[58px] hover:bg-gray-800 transition text-sm font-medium">Book a Test Drive</button>
          </Link>
          <Link href="/contact">
            <button className="h-12 px-8 border border-gray-300 text-gray-800 rounded-[58px] hover:border-black transition text-sm font-medium">Contact Us</button>
          </Link>
        </div>
      </section>
