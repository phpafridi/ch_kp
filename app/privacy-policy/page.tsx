...
export const metadata: Metadata = { title: 'Privacy Policy | Chery KP' }
export default function Page() {
  return (
    <div className="max-w-[900px] mx-auto py-16 px-5 md:px-10">
      <h1 className="text-4xl font-light mb-8">Privacy Policy</h1>
      <p className="text-gray-600 font-light leading-relaxed mb-6">Chery KP is committed to protecting your privacy. This policy explains how we collect, use, and safeguard your personal information.</p>
      ...
      <p className="text-gray-600 font-light leading-relaxed">For privacy concerns, contact us at <a href="mailto:info@cherykp.com" className="underline">info@cherykp.com</a> or call 0336-9999884.</p>
    </div>
  )
}
