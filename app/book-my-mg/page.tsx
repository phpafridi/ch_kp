...
const dealers = ['MG Karachi South', 'MG Karachi North', 'MG Lahore Main', 'MG Lahore DHA', 'MG Islamabad', 'MG Rawalpindi', 'MG Faisalabad', 'MG Multan', 'MG Peshawar', 'MG Quetta']
    ...
    <div className="bg-white">
      <section className="py-16 px-5 md:px-10 bg-[#F7F7F7]">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-light mt-4 mb-4">Book My MG</h1>
          <p className="text-lg text-gray-500 font-light">Your new MG awaits. Fill in the form and our team will be in touch.</p>
        </div>
      </section>
