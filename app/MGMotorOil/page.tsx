...
export const metadata: Metadata = {
  title: 'MG Motor Oil | Premium Engine Protection | MG Motors Pakistan',
  description: 'MG Motor Oil — expertly engineered to enhance engine performance, deliver superior protection, reduce friction, and ensure long-lasting reliability.',
}
...
const grades = [
  ...
  },
  {
    ...
    highlight: 'Best for: MG HS, MG ZS, MG5',
  },
]

const benefits = [
  { icon: '⚙️', title: 'Enhanced Engine Performance', desc: 'Engineered specifically for MG engines to unlock their full potential.' },
  ...
  { icon: '✅', title: 'Warranty Approved', desc: "Using MG Motor Oil ensures your vehicle's 5-year warranty remains fully intact." },
]

export default function MGMotorOilPage() {
  return (
    <div className="bg-white">
      ...
      <section className="relative bg-[#181818] overflow-hidden">
        ...
        <div className="relative z-10 py-24 px-5 md:px-10 text-center">
          <span className="text-[#ADADAD] text-sm font-medium tracking-widest">MG CARE</span>
          <h1 className="text-5xl md:text-7xl font-light text-white mt-4 mb-4">MG Motor Oil</h1>
          <p className="text-xl text-white/70 font-light max-w-xl mx-auto">
            Precision-engineered lubrication for every MG engine
          </p>
        </div>
      </section>
        ...
        <div className="max-w-[1360px] mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-light mt-4 mb-6">
              Built for MG. Trusted by Engineers.
            </h2>
            <p className="text-lg font-light text-gray-700 leading-relaxed text-justify mb-6">
              Introducing MG Motor Oil — expertly engineered to enhance engine performance, deliver superior protection, reduce friction, and ensure long-lasting reliability for every journey.
            </p>
            <p className="text-lg font-light text-gray-700 leading-relaxed text-justify">
              Available in two grades formulated to meet the latest ACEA and API standards, MG Motor Oil is the only oil we trust in every MG leaving our service centres.
            </p>
          </div>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
      ...
      <section className="py-16 px-5 md:px-10">
        <div className="max-w-[1360px] mx-auto">
          <span className="text-[#ADADAD] text-sm font-medium tracking-widest">WHY MG MOTOR OIL</span>
          <h2 className="text-3xl md:text-4xl font-light mt-4 mb-10">6 Reasons to Trust MG Oil</h2>
        ...
        <div className="max-w-[1360px] mx-auto">
          ...
          <div className="overflow-x-auto rounded-xl border border-gray-100">
            <table className="w-full bg-white text-sm">
              ...
              <tbody>
                {[
                  ['MG HS PHEV', '0W-20 SP/C5', '10,000 km / 12 months'],
                  ['MG U9 (Diesel)', '5W-30 SP/C3', '10,000 km / 12 months'],
                  ['MG Cyberster (EV)', 'N/A — Electric', 'Annual inspection only'],
                  ['Binguo EV', 'N/A — Electric', 'Annual inspection only'],
                  ['MG HS (Petrol)', '5W-30 SP/C3', '10,000 km / 12 months'],
                  ['MG ZS EV', 'N/A — Electric', 'Annual inspection only'],
      ...
      <section className="bg-[#181818] py-16 px-5 md:px-10 text-center">
        ...
        <p className="text-white/60 mb-8 text-lg font-light">
          Book a service at any authorized MG dealership and request MG Motor Oil by name.
        </p>
