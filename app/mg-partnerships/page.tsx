...
const steps = [
  { num: '01', title: 'Choose Your MG', desc: 'Select the model that suits your lifestyle and budget.' },
  ...
  { num: '04', title: 'Get Approved', desc: 'Receive your approval and drive away in your new MG.' },
]
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative">
        <img src="/assets/MG_LP_Desk_HeroHeader_768_br.webp" alt="MG Financing" className="w-full h-[280px] md:h-[480px] object-cover" />
        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center text-center px-5">
          ...
          <h1 className="text-4xl md:text-7xl font-light text-white mb-4">Your New MG Awaits</h1>
          <p className="text-lg md:text-2xl text-white/80 font-light max-w-xl">
            Drive your dream MG today with flexible financing through our trusted banking partners.
          </p>
        </div>
      </section>
            ...
            <div className="bg-white rounded-2xl p-8 space-y-5">
              ...
              <div>
                ...
                <select name="model" onChange={handleChange} className="w-full border border-gray-200 rounded-lg px-4 py-3 text-sm focus:outline-none focus:border-black transition bg-white">
                  <option value="">Choose your MG</option>
