...
export const metadata: Metadata = {
  title: 'World of Chery – Latest News & Updates | Chery KP',
  description: 'Stay updated on the latest trends in the automobile industry from Chery KP.',
}

const articles = [
  {
    img: `/assets/MG_tiggo9_Desk_HeroHeader.webp`,
    title: 'Chery at PAPS 2025: Flooded stalls and Exotic cars',
    excerpt: "Chery's debut became the main focus for car enthusiasts at the Pakistan Auto Show 2025 featuring its latest vehicles along with the Chery Tiggo 9 PHEV, Chery Tiggo 8 PHEV, and the Tiggo 7 PHEV.",
    date: 'March 2025',
  },
  {
    img: `/assets/mg-tiggo8/banner/CtymTX.webp`,
    title: 'Chery unveils the all-new Chery Tiggo 7 PHEV and Chery Tiggo 8 at Pakistan Auto Show 2025',
    excerpt: 'Chery launched two new vehicles at the Pakistan Auto Show 2025 in Karachi with an overwhelming response from the audience.',
    date: 'March 2025',
  },
  {
    img: `/assets/tiggo8phev/tiggo8phev-updated.webp`,
    title: 'The True Hybrid Electric is Here',
    excerpt: "Chery's latest campaign for the Chery Tiggo 8 PHEV boldly celebrates innovation, showcasing Chery's leadership in hybrid technology.",
    date: 'February 2025',
  },
  {
    img: `/assets/tiggo8phev/hero.jpg`,
    title: 'Chery KP Reaches 100,000 Customers Milestone',
    excerpt: 'A landmark achievement for Chery KP as we celebrate 100,000 happy customers across the country.',
    date: 'January 2025',
  },
  {
    img: `/assets/tiggo7/tiggo7-index.png`,
    title: 'Introducing the Chery Tiggo 7 PHEV Pickup Truck for Pakistan',
    excerpt: 'The Chery Tiggo 7 PHEV brings together a 2.5L turbo-diesel engine, intelligent 4×4 system, and smart hatch technology for Pakistani drivers.',
    date: 'December 2024',
  },
  {
    img: `/assets/mg-tiggo8/banner/CtymTX.webp`,
    title: 'Chery Tiggo 8: Affordable Electric Mobility for Pakistan',
    excerpt: 'Chery introduces the Chery Tiggo 8 — a compact, city-focused electric vehicle with MAGIC battery technology and up to 333km CLTC range.',
    date: 'November 2024',
  },
]
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="text-center">
            <h1 className="text-4xl md:text-7xl font-light text-white">World of Chery</h1>
      ...
      <section className="py-16 px-5 md:px-10">
        <div className="max-w-[1360px] mx-auto">
          ...
          <div className="mt-6">
            ...
            <p className="text-gray-500 mt-2">MG&apos;s latest campaign for the Chery Tiggo 8 PHEV celebrates the future of hybrid innovation in Pakistan.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#F7F7F7] py-16 px-5 md:px-10 text-center">
        ...
        <p className="text-gray-500 mb-8">Get the latest Chery news, launches, and offers delivered to your inbox.</p>
