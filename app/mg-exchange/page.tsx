...
const benefits = [
  { icon: '🔍', title: 'Quick Inspection', desc: 'Fast and transparent evaluation of your current vehicle by certified MG appraisers.' },
  ...
  { icon: '✅', title: 'Zero Hassle', desc: 'We handle all the paperwork, transfer, and documentation so you can focus on enjoying your new MG.' },
  { icon: '🛡️', title: '6-Month Warranty', desc: 'Buy MG certified used vehicles with a 6-month / 10,000 km warranty (whichever comes first).' },
]
    ...
    <div className="bg-white">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <div className="text-center text-white px-5">
            <h1 className="text-4xl md:text-7xl font-light mb-4">MG Exchange</h1>
            <p className="text-lg md:text-2xl text-white/80 max-w-2xl">MG Exchange — Certified Used Vehicle Program</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1360px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4 mb-10">
            <div className="bg-[#F7F7F7] rounded-xl p-6">
              ...
              <p className="text-gray-600 font-light">Exchange your current vehicle at a fair value at MG dealerships with exciting offers and drive away in a new MG.</p>
            </div>
            <div className="bg-[#F7F7F7] rounded-xl p-6">
              <h3 className="text-lg font-medium mb-2">Buy Certified Used</h3>
              <p className="text-gray-600 font-light">Buy MG certified used vehicle with 6 months / 10,000 km warranty (whichever comes first).</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-[#F7F7F7] py-16 px-5 md:px-10">
        <div className="max-w-[1360px] mx-auto">
          ...
          <h2 className="text-3xl font-light mt-4 mb-10">Why Choose MG Exchange?</h2>
