      ...
      <section id="comfort" className="py-20 px-8 md:pl-20 md:pr-16 bg-[#F7F7F7]">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-16 items-center">
          <ScrollReveal animation="fade-right">
            ...
            <p className="text-base md:text-lg font-light text-gray-600 text-justify leading-relaxed mb-8">Crafted for a connected driving experience, the Chery Tiggo 7 PHEV cabin combines comfort with advanced technology at every touchpoint.</p>
            <ul className="space-y-3">
              {tiggo7ComfortFeatures.map(f=>(
