...
import {
  phevSections, phevHeroStats, phevSafetyStats,
  phevBatterySpecs, phevPilotFeatures, phevDesignFeatures,
  phevComfortFeatures, phevSpecs,
} from '@/data/phev'

export const metadata: Metadata = {
  title: 'MG HS PHEV – True Hybrid Electric | MG Motors Pakistan',
...
export default function PHEVPage() {
  return (
    <div className="bg-white">
      <SectionTracker sections={phevSections} />

      {/* HERO */}
      <section id="hero" className="relative bg-black overflow-hidden" style={{minHeight:'92vh'}}>
        <img src="/assets/phev/phev-updated.webp" alt="MG HS PHEV"
        ...
        <div className="relative z-10 flex flex-col justify-end h-full pb-20 px-8 md:pl-20 md:pr-16" style={{minHeight:'85vh'}}>
          ...
          <h1 className="text-5xl md:text-7xl font-light text-white mb-6 leading-tight"><strong className="font-bold">MG</strong> HS PHEV</h1>
          <div className="flex gap-8 md:gap-16 mb-10">
            {phevHeroStats.map((s,i)=>(
      ...
      <section id="performance" className="py-20 px-8 md:pl-20 md:pr-16 bg-[#181818]">
        <div className="max-w-[1200px] mx-auto">
          ...
          <ScrollReveal animation="scale-up" delay={150}>
            <img src="/assets/phev/phev-updated.webp" alt="Performance" className="w-full rounded-2xl object-cover h-[300px] md:h-[520px]" style={{objectPosition:'50% 60%'}} />
          </ScrollReveal>
        </div>
      </section>

      {/* PLUG-IN HYBRID */}
      <section id="plugin-hybrid" className="py-20 px-8 md:pl-20 md:pr-16 bg-white">
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-16 items-center">
          <ScrollReveal animation="fade-right">
            ...
            <p className="text-base md:text-lg font-light text-gray-600 text-justify leading-relaxed mb-8">With a 16.6kWh Ternary Lithium Battery, the MG HS PHEV gives you the freedom to drive on pure electricity for over 50km.</p>
            <div className="flex flex-col gap-3">
              {phevBatterySpecs.map(({key,value})=>(
      ...
      {/* MG PILOT */}
      <section id="mg-pilot" className="py-20 px-8 md:pl-20 md:pr-16 bg-[#F7F7F7]">
        <div className="max-w-[1200px] mx-auto">
          <ScrollReveal animation="fade-up">
            <span className="text-xs tracking-[0.2em] text-[#ADADAD] font-medium uppercase">Technology</span>
            <h2 className="text-4xl md:text-5xl font-light mt-3 mb-6">MG Pilot</h2>
            <p className="text-base md:text-lg font-light text-gray-600 max-w-2xl text-justify leading-relaxed mb-10">MG sets the standard for safety with the MG Pilot Safety Suite by ensuring a safe, relaxing, and comfortable driving experience across 11 intelligent systems.</p>
          </ScrollReveal>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {phevPilotFeatures.map((f,i)=>(
      ...
      <section id="design" className="py-20 px-8 md:pl-20 md:pr-16 bg-white">
        <div className="max-w-[1200px] mx-auto">
          <ScrollReveal animation="fade-up">
            ...
            <p className="text-base md:text-lg font-light text-gray-600 max-w-2xl text-justify leading-relaxed mb-12">The MG HS PHEV commands attention with its sharp front fascia, sculpted bodywork, and signature MG Star Matrix grille.</p>
          </ScrollReveal>
          <ScrollReveal animation="scale-up" delay={100}>
            <div className="grid grid-cols-3 gap-4">
              <img src="/assets/phev/phev-updated.webp" alt="Front" className="w-full rounded-2xl object-cover h-48 col-span-2" />
              <img src="/assets/phev/phev-updated.webp" alt="Side" className="w-full rounded-2xl object-cover h-48" />
              <img src="/assets/phev/phev-updated.webp" alt="Rear" className="w-full rounded-2xl object-cover h-48" />
              <img src="/assets/Interior1.png" alt="Interior" className="w-full rounded-2xl object-cover h-48 col-span-2" />
            </div>
          </ScrollReveal>
          <div className="grid grid-cols-3 gap-8 mt-12">
            {phevDesignFeatures.map((f,i)=>(
