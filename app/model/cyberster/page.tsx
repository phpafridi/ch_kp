...
import {
  cybersterSections, cybersterHeroStats, cybersterDesignImages,
  cybersterDesignQuote, cybersterPerfStats, cybersterInteriorFeatures,
  cybersterElectricSpecs, cybersterSpecs,
} from '@/data/cyberster'

export const metadata: Metadata = {
  title: 'MG Cyberster – 100% Electric Roadster | MG Motors Pakistan',
  description: '375kW, 0-100 in 3.2 seconds, 507km range. The MG Cyberster — an all-electric British roadster.',
}

export default function CybersterPage() {
  return (
    <div className="bg-black">
      <SectionTracker sections={cybersterSections} />

      {/* HERO */}
      <section id="hero" className="relative overflow-hidden" style={{minHeight:'92vh'}}>
        <img src="/assets/MG_cyberster_Desk_HeroHeader.webp" alt="MG Cyberster"
        ...
        <div className="relative z-10 flex flex-col justify-end h-full pb-20 px-8 md:pl-20 md:pr-16" style={{minHeight:'85vh'}}>
          ...
          <h1 className="text-5xl md:text-7xl font-light text-white mb-6 leading-tight"><strong className="font-bold">MG</strong> Cyberster</h1>
          <div className="flex gap-8 md:gap-16 mb-10">
            {cybersterHeroStats.map((s,i)=>(
          ...
          <ScrollReveal animation="fade-up" delay={100}>
            <div className="grid md:grid-cols-2 gap-12 items-center mb-12">
              <p className="text-base md:text-lg font-light text-gray-600 text-justify leading-relaxed">
                Blending MG&apos;s Iconic Heritage with the Vigour of Modern Electric Innovation. The Cyberster isn&apos;t just any Car — it&apos;s a Statement. A Tribute to those who Defy the Ordinary.
              </p>
              <blockquote className="border-l-4 border-black pl-6">
                <p className="text-lg md:text-xl font-light text-gray-700 italic leading-relaxed">&ldquo;{cybersterDesignQuote.text}&rdquo;</p>
                <cite className="text-sm text-gray-400 mt-3 block not-italic">{cybersterDesignQuote.author}</cite>
              </blockquote>
            </div>
          </ScrollReveal>
          <ScrollReveal animation="scale-up" delay={150}>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <img src={cybersterDesignImages[0].src} alt={cybersterDesignImages[0].alt} className="w-full rounded-2xl object-cover h-48 col-span-2 md:col-span-1 md:row-span-2 md:h-full" />
              <img src={cybersterDesignImages[1].src} alt={cybersterDesignImages[1].alt} className="w-full rounded-2xl object-cover h-48" />
              <img src={cybersterDesignImages[2].src} alt={cybersterDesignImages[2].alt} className="w-full rounded-2xl object-cover h-48" />
            </div>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section id="performance" className="py-20 px-8 md:pl-20 md:pr-16 bg-[#181818]">
        <div className="max-w-[1200px] mx-auto">
          ...
          <ScrollReveal animation="scale-up" delay={100}>
            <img src="/assets/MG_cyberster_Desk_HeroHeader.webp" alt="Cyberster Performance"
      ...
      <section id="interior" className="py-20 px-8 md:pl-20 md:pr-16 bg-white">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-8">
            {cybersterInteriorFeatures.map((f,i)=>(
          ...
          <ScrollReveal animation="scale-up" delay={100}>
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {cybersterDesignImages.map((img,i)=>(
        ...
        <div className="max-w-[1200px] mx-auto grid md:grid-cols-2 gap-16 items-center">
          <ScrollReveal animation="fade-right">
            ...
            <div className="space-y-4">
              {cybersterElectricSpecs.map(({key,value})=>(
      ...
      <section id="specs" className="py-20 px-8 md:pl-20 md:pr-16 bg-white">
        <div className="max-w-[1200px] mx-auto">
          ...
          <ScrollReveal animation="fade-up" delay={100}>
            <div className="mt-8">
              <a href="/assets/brochure/MG-Cyberster-Brochure.pdf" target="_blank" rel="noopener noreferrer"
