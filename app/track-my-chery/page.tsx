...
const mockOrders: Record<string, { model: string; color: string; dealer: string; date: string; status: Status; progress: number }> = {
  'CHERY-123456': { model: 'Chery Tiggo 8 PHEV', color: 'Pearl White', dealer: 'Chery KP — Main Ring Road, Peshawar', date: 'May 2025', status: 'In Production', progress: 40 },
  'CHERY-789012': { model: 'Chery Tiggo 7 PHEV', color: 'Midnight Black', dealer: 'Chery KP — Main Ring Road, Peshawar', date: 'June 2025', status: 'Dispatched', progress: 80 },
  'CHERY-345678': { model: 'Chery Tiggo 8', color: 'Avocado Green', dealer: 'Chery KP — Main Ring Road, Peshawar', date: 'April 2025', status: 'Ready for Delivery', progress: 100 },
}
...
export default function TrackMyMGPage() {
  ...
  const handleVerify = () => {
    ...
    if (found) {
      ...
      setOrder({ model: 'Chery Tiggo 8 PHEV', color: 'Pearl White', dealer: 'Chery KP — Main Ring Road, Peshawar', date: 'May 2025', status: 'In Production', progress: 40 })
      setStage('result')
      setError('')
    }
  }
    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="py-16 px-5 md:px-10 bg-[#F7F7F7]">
        <div className="max-w-[1360px] mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-light mt-4 mb-2">Track My Chery</h1>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-[#F7F7F7] rounded-2xl p-6">
                ...
                <ol className="space-y-2">
                  {[
                    'Enter your Chery Booking/Order Number from your confirmation email.',
                ...
                <p className="text-xs text-gray-400 mt-4">Need help? Contact <a href="mailto:info@cherykp.com" className="underline">info@cherykp.com</a></p>
              </div>
          ...
          {stage === 'result' && order && (
            <div className="space-y-8 animate-fadeIn">
              ...
              <div className="border border-gray-100 rounded-xl p-5 text-xs text-gray-400 leading-relaxed">
                <strong className="text-gray-600">Confidentiality Statement:</strong> The information provided on this page is confidential and intended solely for the registered customer of Chery KP. By entering your PBO Number, you acknowledge that the retrieved booking details are for your personal reference only. Any unauthorized access, sharing, or misuse of this data is strictly prohibited.
              </div>
