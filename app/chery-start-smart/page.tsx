...
const reasons = [
  { emoji: '⚡', title: 'True Hybrid Technology', desc: 'The Chery Tiggo 8 PHEV blends electric efficiency with petrol convenience — over 50km of pure electric range, zero compromises.' },
  { emoji: '🛡️', title: "Pakistan's Best Warranty", desc: '5-year / 100,000km warranty that gives you complete peace of mind from day one.' },
  { emoji: '💡', title: 'Chery Driver Assist Safety Suite', desc: '11 intelligent driver-assistance features to keep you safe on every Pakistani road.' },
  { emoji: '💰', title: 'Flexible Financing', desc: '9 partner banks, Islamic and conventional options, making your Chery accessible without compromise.' },
]

export default function StartSmartPage() {
  const [form, setForm] = useState({ name:'', model:'Chery Tiggo 8 PHEV', email:'', phone:'', landline:'', city:'', address:'', dealer:'', date:'', delivery:'' })
  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative">
        <img src="/assets/tiggo8phev/tiggo8phev-updated.webp" alt="Chery Start Smart Campaign" className="w-full h-[280px] md:h-[560px] object-cover" />
        <div className="absolute inset-0 bg-gradient-to-r from-black/70 via-black/40 to-transparent flex flex-col justify-center px-8 md:px-16">
          ...
          <h1 className="text-4xl md:text-7xl font-light text-white leading-tight mb-4">
            Chery Start Smart<br />This Year
          </h1>
      ...
      <section className="py-16 px-5 md:px-10">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="text-lg md:text-xl font-light text-gray-700 leading-relaxed">
            The Chery Start Smart campaign is about making a decision that feels right from day one. One that blends intelligent technology, refined performance, and meaningful value into a drive that works for everyday life.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-5 md:px-10">
        <div className="max-w-[1360px] mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-3xl md:text-5xl font-light mt-4 mb-6">Chery Tiggo 8 PHEV</h2>
          ...
          <img src="/assets/tiggo8phev/tiggo8phev-updated.webp" alt="Chery Tiggo 8 PHEV" className="w-full rounded-xl object-contain max-h-[400px]" />
        </div>
      </section>
      ...
      <section id="book-form" className="py-16 px-5 md:px-10 bg-[#F7F7F7]">
        <div className="max-w-[700px] mx-auto">
          ...
          <h2 className="text-3xl font-light mt-4 mb-8">Book My Chery Tiggo 8 PHEV</h2>
          {submitted ? (
